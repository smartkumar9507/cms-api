...
const addDetails = async (req, res) => {
    try {
        ...
        user = await facultyDetails.create({ ...req.body, profile: req.body.profile });
        const data = {
            success: true,
...
const getAllFaculties = async (req,res)=>{
    try {
        ...
        if(!faculties) return res.status(404).json({
            success:false,
...
module.exports = { getDetails, addDetails, updateDetails, deleteDetails, getCount, getAllFaculties }